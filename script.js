...
const languageTargets = [
  { selector: ".nav a[href='#about']", en: "About" },
  { selector: ".nav a[href='#programs']", en: "Classes" },
  { selector: ".nav a[href='#faculty']", en: "Faculty" },
  { selector: ".nav a[href='#gallery']", en: "Gallery" },
  { selector: ".nav a[href='#contact']", en: "Locations" },
  { selector: ".nav .nav-cta", en: "Book a Trial" },
  { selector: ".hero-slogan", en: "LOVE YOUR BODY. BE BALLET." },
  { selector: ".brand-headline", en: "B-BALLET" },
  {
    selector: ".hero-copy",
    en: "Begin by understanding your body,<br />discover movement,<br />and meet your own beautiful expression.",
  },
  { selector: ".hero-actions .button.primary", en: "Book a Trial Class" },
  { selector: ".hero-actions .button.ghost", en: "Kakao Inquiry by Branch" },
  { selector: ".brand-about .section-heading .eyebrow", en: "About" },
  {
    selector: ".brand-about .section-heading h2",
    en: 'B-BALLET begins with <span class="text-accent">an attitude of understanding the body</span>.',
  },
  {
    selector: ".brand-about .story-lead",
    en: "B-BALLET sees ballet as more than technique. It is a way to understand the body and learn expression.",
  },
  {
    selector: ".brand-about .story-copy p:nth-of-type(2)",
    en: "We care less about how quickly someone improves, and more about what kind of awareness and attitude they build while moving.",
  },
  {
    selector: ".brand-about .story-copy p:nth-of-type(3)",
    en: "From children to adults, from hobby classes to pre-professional training, each goal may be different, but the essence of good education remains the same.",
  },
  {
    selector: ".brand-about .story-copy p:nth-of-type(4)",
    en: "Respect for the body, attention to the basics, and growth that can last. This is the ballet B-BALLET pursues.",
  },
  { selector: ".principles-label", en: "B-BALLET Education Process" },
  { selector: ".story-principles div:nth-of-type(1) p", en: "Understand how your body moves and feels." },
  { selector: ".story-principles div:nth-of-type(2) p", en: "Learn healthy posture and alignment." },
  { selector: ".story-principles div:nth-of-type(3) p", en: "Build your own expression through movement." },
  {
    selector: ".brand-statement p",
    en: "Beyond learning ballet, we learn how to understand and express the body.",
  },
  {
    selector: ".brand-statement span",
    en: "A moment to love your body and meet your most beautiful movement.",
  },
  {
    selector: ".brand-programs .section-heading h2",
    en: 'Different classes, one direction. <span class="text-accent">Ballet that understands the body.</span>',
  },
  ...
  { selector: ".brand-gallery .eyebrow", en: "Gallery" },
  {
    selector: ".brand-gallery .section-heading h2",
    en: 'Space, classes, and stage become one <span class="text-accent">brand scene</span>.',
  },
