...
const languageTargets = [
  ...
  },
  {
    ...
    en: "B-BALLET is a premium educational space that prioritizes dancers' inner experience and physical well-being over rapid technical progress. Through expert-led instruction, we bridge the gap between recreational ballet and professional training.",
  },
  {
    selector: ".brand-about .story-copy p:nth-of-type(2)",
    en: "Whether you pursue ballet as a hobby or a professional path, we help you find balance and beauty through movement.",
  },
  {
  ...
  { selector: ".philosophy-values li:nth-child(1)", en: "Body Understanding" },
  { selector: ".philosophy-values li:nth-child(2)", en: "Process over Results" },
  { selector: ".philosophy-values li:nth-child(3)", en: "Sustainable Growth" },
  { selector: ".philosophy-values li:nth-child(4)", en: "Artistic Expression" },
  ...
  },
  {
    ...
    en: "Bridging the gap between recreational ballet and professional training.",
  },
  { selector: ".brand-programs .section-heading .eyebrow", en: "Programs" },
  {
    selector: ".brand-programs .section-heading h2",
    en: "Specialized Training",
  },
  { selector: ".brand-programs .section-summary", en: "Offering specialized ballet training for young children, students, and adults at our Seongnam and Songpa studios." },
  ...
  { selector: ".program-card:nth-child(2) p", en: "Develop alignment, balance, and focus with training designed for growing bodies." },
  { selector: ".program-card:nth-child(3) h3", en: "Pre-Professional" },
  { selector: ".program-card:nth-child(3) p", en: "Build strong fundamentals, repertoire, and stage awareness through structured training." },
  { selector: ".program-card:nth-child(4) h3", en: "Adult Ballet" },
  { selector: ".program-card:nth-child(4) p", en: "Reconnect with movement through classes designed for adult learners." },
  ...
  { selector: ".program-card:nth-child(9) p", en: "Bring movement learned in class to life through repertoire and meaningful stage experience." },
  { selector: ".trial-invite h2", en: "Interested in joining?" },
  { selector: ".trial-invite p", en: "New students can receive guidance and experience a B-BALLET class before enrolling." },
  ...
  { selector: ".faculty .eyebrow", en: "Director & Faculty" },
  {
    ...
    en: "The People Behind B-BALLET",
  },
  { selector: ".director-copy h3", en: "Director Kwon Bobin" },
  { selector: ".director-copy > p:first-child", en: "Director" },
  {
    selector: ".director-copy p:nth-of-type(2)",
    en: "With more than 10 years of experience in ballet education, Director Kwon leads the classes and stage work at our Seongnam and Songpa studios. She values process over results and awareness over technique.",
  },
  {
  ...
  { selector: ".director-profile li:nth-child(1)", en: "Over 10 years of ballet education experience" },
  { selector: ".director-profile li:nth-child(2)", en: "Leads the Seongnam and Songpa studios" },
  { selector: ".director-profile li:nth-child(3)", en: "Performance production and arts management" },
  { selector: ".teacher-branch:nth-of-type(1) h3", en: "Seongnam Faculty" },
  { selector: ".teacher-branch:nth-of-type(2) h3", en: "Songpa Faculty" },
  { selector: ".teacher-branch:nth-of-type(1) .teacher-branch-heading strong", en: "Seongnam Studio" },
  { selector: ".teacher-branch:nth-of-type(2) .teacher-branch-heading strong", en: "Songpa Studio" },
  ...
  { selector: ".teacher-branch:nth-of-type(1) .teacher-list article:nth-child(3) span", en: "Instructor Park Mi-joo" },
  { selector: ".teacher-branch:nth-of-type(1) .teacher-list article:nth-child(4) span", en: "Instructor Jo Hyun-soo" },
  { selector: ".teacher-branch:nth-of-type(1) .teacher-list article:nth-child(5) span", en: "Instructor Kim Jin-ah" },
  { selector: ".teacher-branch:nth-of-type(1) .teacher-list article:nth-child(6) span", en: "Manager Yoo Mi-ran" },
  ...
  },
  {
    ...
    en: "Choose the studio and class that suit you. We will guide you through trial scheduling, registration, and payment by email or Kakao.",
  },
  { selector: ".contact-main-cta", en: "Book a Trial Class Consultation" },
  { selector: ".contact-social a[href*='blog.naver.com']", en: "Blog" },
  { selector: ".contact-branch-card:nth-child(1) .branch-label", en: "Seongnam" },
  { selector: ".contact-branch-card:nth-child(2) .branch-label", en: "Songpa" },
  { selector: ".contact-branch-card:nth-child(1) h3", en: "Seongnam Studio" },
  ...
  { selector: ".contact-branch-card:nth-child(2) h3", en: "Songpa Studio" },
  ...
  { selector: ".trial-hero h1", en: "Trial Class Consultation" },
  {
    ...
    en: "Tell us your preferred studio, class, and time. We will organize your inquiry so you can send it by email or Kakao. Trial availability and registration details are provided after consultation.",
  },
  ...
  { selector: ".trial-result .eyebrow", en: "Message" },
  {
...
const languageAttributeTargets = [
  { selector: ".brand", attribute: "aria-label", en: "B-BALLET home" },
  ...
  { selector: "img[src='assets/gallery-line-detail.jpg']", attribute: "alt", en: "Étude in a burgundy leotard and pointe shoes" },
  { selector: "img[src='assets/brand-kids-class.jpg']", attribute: "alt", en: "Kids ballet class at B-BALLET" },
  { selector: "img[src='assets/seongnam-junior-training.jpg']", attribute: "alt", en: "Junior ballet training at B-BALLET" },
  { selector: "img[src='assets/gallery-solo-window-arabesque.jpg']", attribute: "alt", en: "Pre-professional ballet étude at B-BALLET" },
  { selector: "img[src='assets/brand-gallery-adult-class.jpg']", attribute: "alt", en: "Adult ballet class at B-BALLET" },
  { selector: "img[src='assets/brand-gallery-performance-pink.jpg']", attribute: "alt", en: "B-BALLET repertoire performance" },
  { selector: "img[src='assets/hero-main-guidance.jpg']", attribute: "alt", en: "Private ballet instruction at B-BALLET" },
  { selector: "img[src='assets/gallery-junior-soft-trio.jpg']", attribute: "alt", en: "Small-group ballet lesson at B-BALLET" },
  { selector: "img[src='assets/gallery-kids-line-turquoise.jpg']", attribute: "alt", en: "Children's ballet class at B-BALLET" },
